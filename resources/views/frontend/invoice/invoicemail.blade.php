                                            ...
                                            @foreach (App\Models\OrderProduct::where('order_id', $order_id)->get() as $product)
                                                <tr>
                                                    ...
                                                    <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1e2b33;  line-height: 18px;  vertical-align: top; padding:10px 0;"
                                                        align="right">{{ $product->price * $product->quantity }}</td>
                                                </tr>
                                            @endforeach
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    {{ $billing->address }}<br>
                                                                    {{ $billing->rel_to_city->name }}<br>
                                                                    {{ $billing->rel_to_country->name }}<br>
                                                                    {{ $billing->zip }}<br>
                                                                    {{ $billing->phone }}
                                                                </td>
                                                            </tr>
