...
<html lang="en">
  ...
  <body>
    <header class="clearfix">
      <div id="logo">
        <img src="https://i.postimg.cc/HxPrmFhR/favicon.png">
      </div>
      <div id="company">
        <h2 class="name">EcomGrove</h2>
        <div>Khilkhet,Dhaka-1212</div>
        <div>(+88) 01521308560</div>
        <div><a href="mailto:company@example.com">ecomgrove.bus@gmail.com</a></div>
      </div>
      </div>
    </header>
    @php
