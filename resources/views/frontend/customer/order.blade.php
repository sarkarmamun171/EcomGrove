            ...
            <div class="col-lg-3">
                <div class="card text-center pt-3" style="width: 18rem;">
                    @if (Auth::guard('customer')->user()->photo == null)
                        <img src="{{ Avatar::create(Auth::guard('customer')->user()->fname)->toBase64() }}" width="50"
                            class="m-auto" />
                    @else
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><a href="{{ route('customer.logout') }}" class="text-dark">Logout</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($myorder->status != 5)
                                            ...
                                            <a href="{{ route('cancel.myorder', $myorder->id) }}"
